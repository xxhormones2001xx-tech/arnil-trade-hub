...
import { ArrowRight, ShieldCheck, Zap, LineChart, Bitcoin, PieChart, Smartphone, Star } from "lucide-react";
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-24 md:grid-cols-2 md:px-6 md:py-32">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-brand/30 bg-brand/10 px-3 py-1 text-xs font-semibold text-brand">
              <Zap className="h-3.5 w-3.5" /> New: Fractional shares from $1
            </span>
            <h1 className="mt-5 font-display text-5xl font-bold leading-[1.05] md:text-6xl">
              Trade smarter.<br />Invest with <span className="text-brand">confidence.</span>
            </h1>
            <p className="mt-6 max-w-lg text-lg text-background/75">
              Stocks, ETFs, options, futures and crypto — all in one modern brokerage account. Zero-commission trades, pro-grade research, and 24/7 human support.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-6">
        <div className="rounded-3xl bg-gradient-to-br from-ink to-ink/80 p-10 text-background md:p-16">
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              <h2 className="font-display text-4xl font-bold md:text-5xl">Get up to <span className="text-brand">$1,000</span> when you fund a new account.</h2>
